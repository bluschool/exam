...
class ExamServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->addConfigComponent('bluschool/exam', 'bluschool/exam', $path.'/resources/config');
        $this->addLanguageComponent('bluschool/exam', 'bluschool/exam', $path.'/resources/lang');
        $this->addViewComponent('bluschool/exam', 'bluschool/exam', $path.'/resources/views');
    ...
    {
        $this->app['events']->listen('orchestra.ready: admin', 'Bluschool\Exam\Http\Handlers\ExamMenuHandler');
    }
    ...
    {
        $this->app['orchestra.extension.config']->map('bluschool/exam', [
